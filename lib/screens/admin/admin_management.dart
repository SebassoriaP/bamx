...
class _AdminManagementState extends State<AdminManagement> {
  ...
  final CollectionReference _adminsRef = FirebaseFirestore.instance.collection(
    'admins',
  );
  ...
  Future<void> _addAdmin() async {
    ...
    try {
      final existingAdmin = await _adminsRef
      ...
      await _adminsRef.add({'email': email, 'createdAt': DateTime.now()});
